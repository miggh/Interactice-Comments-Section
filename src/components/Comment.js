...
class Comment extends React.Component {
  ...
  plusHandler = () => {
    if (this.state.score > this.props.score) return;
  ...
  onAddReply = (uploadReply) => {
    ...
    this.setState((prevState) => {
      return {
        replies: [...prevState.replies, userUpload],
        showReplyForm: false,
      };
    });
  };
  ...
  onDelete = (index) => {
    this.setState((prevState) => {
      prevState.replies.splice(index, 1);
      return {
      ...
      <div className="comment-group">
        ...
        <div className="comment">
          <div className="comment--score">
            <button className="btn btn--score" onClick={this.plusHandler}>
              <svg
            ...
            <button className="btn btn--score" onClick={this.minusHandler}>
              <svg
          ...
          <div className="comment--main">
            <div className="comment--user">
              ...
              <p className="user--created-at">{this.props.createdAt}</p>
        ...
        {this.state.showReplyForm && (
          <NewReply
            currentUser={this.props.currentUser}
            replyTo={this.props.user.username}
            onAddReply={this.onAddReply}
            onReplyToReply={this.onReplyToReply}
          />
        )}
        <div className="reply-group">{renderReplies}</div>
      </div>
    );
  }
}
